...
$(document).on("ready", function(){
  ...
  /*var currentTime= moment().format("hh:mm:ss")*/
    ...
    var hours=moment.tz(getTimeZone()).format('hh')
    console.log(hours)
    var minutes=moment.tz(getTimeZone()).format('mm')
    var seconds=moment.tz(getTimeZone()).format('ss')
